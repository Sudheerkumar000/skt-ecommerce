...
const HomePage = ({ deals }) => {
  ...
  return (
    <>
      <section className="rounded-3xl border border-slate-200 bg-gradient-to-br from-white via-slate-50 to-slate-100 px-6 py-10 shadow-sm md:px-10">
            ...
            <div className="overflow-hidden rounded-2xl">
              ...
              >
                {heroSlides.map((slide) => (
                  ...
                  >
                    <div className="relative h-52 overflow-hidden rounded-2xl bg-gradient-to-br from-slate-200 via-slate-100 to-slate-50">
                    ...
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-xs text-slate-500">{slide.color}</p>
                      </div>
                      <p className="text-sm font-semibold text-slate-900">
                        $
                        {Math.round(
      ...
      <section className="mt-12 rounded-3xl border border-slate-200 bg-white px-6 py-6 shadow-sm md:px-10">
      ...
      <section className="mt-14 space-y-6">
        <div className="flex items-center justify-between">
          <h2 className="text-xl font-semibold text-slate-900">Featured picks</h2>
        ...
        <div className="grid gap-6 md:grid-cols-3">
          {deals.slice(0, 3).map((item) => (
            ...
            >
              <div className="relative mb-4 h-40 overflow-hidden rounded-xl bg-gradient-to-br from-slate-100 via-slate-50 to-white">
                <div className="absolute inset-0 animate-pulse bg-gradient-to-r from-transparent via-white/60 to-transparent" />
              </div>
              <div className="flex items-center justify-between">
                <div>
              ...
              <div className="mt-4 grid gap-2">
                ...
                <Link
                  to={`/product/${item.id}`}
                  className="rounded-full bg-slate-900 px-4 py-2 text-center text-xs font-semibold text-white transition hover:bg-slate-800"
                >
                  View Deal
                </Link>
              </div>
            ...
            {recommendations.map((item) => (
              ...
              >
                ...
                <div className="text-right">
                  ...
                  <button className="mt-1 text-xs font-semibold text-slate-600 hover:text-slate-900">
                    View
                  </button>
                </div>
              </div>
      ...
      <section className="mt-14 rounded-3xl border border-slate-200 bg-white px-6 py-8 shadow-sm md:px-10">
        <div className="flex flex-wrap items-center justify-between gap-4">
          <div>
            <p className="text-xs uppercase tracking-[0.3em] text-slate-400">
              Reviews
